                ...
                {this.state.visible
                    ? < form >
                        <div className="px-4 py-4 border-t border-gray-900 sm:flex sm:-mx-2">
                            ...
                            <div className="mt-4 sm:w-1/2 sm:px-2 sm:mt-0">
                                <label>
                        ...
                        <div className="px-4 py-4 border-t border-gray-900">
                            ...
                            <div className="sm:flex sm:-mx-2">
                                <label className="mt-2 sm:w-1/4 sm:px-2 flex item-center">
                        ...
                        <div className="px-4 py-4 border-t border-gray-900">
                            ...
                            <div className="sm:flex sm:-mx-2 sm:flex-wrap">
                                <label className="mt-2 flex text-white sm:w-1/4 sm:px-2">
                        ...
                        <div className="bg-gray-900 px-4 py-4 sm:text-right">
                            <button className="block w-full sm:w-auto sm:inline-block bg-indigo-500 hover:bg-indigo-400 font-semibold rounded-lg text-white px-4 py-2">Update results</button>
                        </div>
                    </form> : <></>
                }
            </section>
