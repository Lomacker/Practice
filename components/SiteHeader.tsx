    ...
    return (
      <header className="bg-gray-900">
        <div className="flex justify-between item-center px-4 py-3">
          ...
          <button onClick={this.toggleMenu} className="px-2 text-gray-500 hover:text-white focus:outline-none focus:text-white">
            {this.state.visible
          ...
          ? <div>
            <nav>
              <div className="px-2 pt-2 pb-5 border-b border-gray-800">
                ...
                <a href="#" className="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-800">Trips</a>
                <a href="#" className="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-800">Messages</a>
              </div>
